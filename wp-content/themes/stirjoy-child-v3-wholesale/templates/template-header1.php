<header class="header1">
  ...
  <nav class="navbar navbar-default" id="theme-main-head">
    ...
    <?php 
    // Don't render cart sidebar here on shop pages - it's handled by cart-sidebar.php template
    // This prevents duplicate header7 elements on shop pages
    // Render cart sidebar on all other pages (My Account, etc.) - no Redux dependency
