...
if ( ! class_exists( 'Woocommerce_Subscription_Pro_Plan_Going_To_Expire_Email' ) ) {
	 ...
	 * @subpackage Woocommerce_Subscriptions_Pro/email
	 */
	class Woocommerce_Subscription_Pro_Plan_Going_To_Expire_Email extends WC_Email {
		/**
		...
		public function __construct() {
			...
			$this->id          = 'wps_wsp_plan_going_expire';
			$this->title       = __( 'Subscription Going To Expire Email Notification', 'woocommerce-subscriptions-pro' );
			$this->customer_email = true;
			$this->description = __( 'This Email Notification Send to customer if any subscription plan going to expire', 'woocommerce-subscriptions-pro' );

			$this->template_html  = 'wps-wsp-plan-going-to-expire-email-template.php';
			$this->template_plain = 'plain/wps-wsp-plan-going-to-expire-email-template.php';
		...
		public function get_default_subject() {
			return __( 'Subscription going to expire', 'woocommerce-subscriptions-pro' );
		}
...
return new Woocommerce_Subscription_Pro_Plan_Going_To_Expire_Email();
