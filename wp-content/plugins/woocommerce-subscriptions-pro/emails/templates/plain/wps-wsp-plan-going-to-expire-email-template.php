...
<p><?php printf( esc_html__( 'A subscription [#%s] has been expired. Their subscription\'s details are as follows:', 'woocommerce-subscriptions-pro' ), esc_html( $wps_subscription ) ); ?></p>
