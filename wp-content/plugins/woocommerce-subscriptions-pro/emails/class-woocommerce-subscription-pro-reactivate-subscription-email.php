...
if ( ! class_exists( 'Woocommerce_Subscription_Pro_Reactivate_Subscription_Email' ) ) {
	 ...
	 * @subpackage Woocommerce_Subscriptions_Pro/email
	 */
	class Woocommerce_Subscription_Pro_Reactivate_Subscription_Email extends WC_Email {
		/**
		...
		public function __construct() {
			...
			$this->id          = 'wps_wsp_reactivate_subscription';
			$this->title       = __( 'Reactivate Subscription Email Notification', 'woocommerce-subscriptions-pro' );
			$this->description = __( 'This Email Notification Send if any subscription is Reactivated', 'woocommerce-subscriptions-pro' );
			$this->template_html  = 'wps-wsp-reactivate-subscription-email-template.php';
			$this->template_plain = 'plain/wps-wsp-reactivate-subscription-email-template.php';
		...
		public function get_default_subject() {
			return __( 'Reactivated Susbcription Email {site_title}', 'woocommerce-subscriptions-pro' );
		}
		...
		public function get_default_heading() {
			return __( 'Subscription Reactivated', 'woocommerce-subscriptions-pro' );
		}
...
return new Woocommerce_Subscription_Pro_Reactivate_Subscription_Email();
