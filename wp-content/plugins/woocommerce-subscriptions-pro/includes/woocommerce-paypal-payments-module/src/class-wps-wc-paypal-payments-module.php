 ...
 */
class WPS_WC_PayPal_Payments_Module implements ServiceModule, ExtendingModule, ExecutableModule {
	 ...
	 * @return bool True if the module was run successfully, false otherwise.
	 */
