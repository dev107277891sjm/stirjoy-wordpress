    ...
    class ReduxFramework_wbc_importer {
        ...
        public function render() {
            ...
            if ( !empty( $this->field['wbc_demo_imports'] ) ) {
                ...
                if (themeslrav3_is_license_activated()) {
                    ...
                    echo "<h3>Your license has not been activated yet. Please navigate to the <a href=".admin_url('admin.php?page=themeslr-license').">Theme License Activation</a> page to activate your license key.</h3>";
                }
            } else {
