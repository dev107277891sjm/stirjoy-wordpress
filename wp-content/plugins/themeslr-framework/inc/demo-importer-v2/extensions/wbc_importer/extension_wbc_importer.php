...
if ( !class_exists( 'ReduxFramework_extension_wbc_importer' ) ) {
    ...
    class ReduxFramework_extension_wbc_importer {
        ...
        function add_importer_section() {
            ...
            $server_requirements = '';
            $server_requirements .= '<div id="info-opt-notice-success" class="hasIcon redux-info   redux-info-field redux-field-info">';
    ...
    function wbc_extended_example( $demo_active_import , $demo_directory_path ) {
        ...
        */
        ...
        if ( class_exists( 'RevSlider' ) ) {
            $wbc_sliders_array = array(
                'Beauty Crates'     => array('beauty-crates.zip'),
                'Shave Crates'     => array('beauty-crates.zip'),
                'Organic Food Crates'     => array('beauty-crates.zip'),
                'Coffee Crates'     => array('beauty-crates.zip'),
                'Meal Kits Crates'     => array('beauty-crates.zip'),
                'Puppy Crates'     => array(),
                'Kitten Crates'     => array(),
            );
        ...
        */
        ...
        $wbc_home_pages = array(
            'Beauty Crates'   => 'Home Main',
            'Shave Crates'   => 'Shave Crates',
            'Organic Food Crates'   => 'Organic Food Crates',
            'Coffee Crates'   => 'Coffee Crates',
            'Meal Kits Crates'   => 'Meal Kits Crates',
            'Puppy Crates'   => 'PuppyCrate Home',
            'Kitten Crates'   => 'Home',
        );
        ...
        if ( isset( $demo_active_import[$current_key]['directory'] ) && !empty( $demo_active_import[$current_key]['directory'] ) && array_key_exists( $demo_active_import[$current_key]['directory'], $wbc_home_pages ) ) {
            ...
            if ( isset( $page->ID ) ) {
                ...
                // Wishlist and Compare options plugin
                update_option('woosw_button_position_single', '0');
                update_option('woosc_button_single', '0');
