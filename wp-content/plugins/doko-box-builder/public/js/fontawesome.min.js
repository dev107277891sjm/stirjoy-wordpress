...
! function () {
	...
	function W(r) {
		for (var t = 1; t < arguments.length; t++) {
			...
			"function" == typeof Object.getOwnPropertySymbols && (n = n.concat(
				...
				function (t) {
					var n, e, a;
					n        = r, a = i[e = t], e in n ? Object.defineProperty(
						n,
						e,
						{
							value: a,
	...
	if (p && "function" == typeof p.querySelector) {
		[ [ "data-family-prefix", "familyPrefix" ], [ "data-replacement-class", "replacementClass" ], [ "data-auto-replace-svg", "autoReplaceSvg" ], [ "data-auto-add-css", "autoAddCss" ], [ "data-auto-a11y", "autoA11y" ], [ "data-search-pseudo-elements", "searchPseudoElements" ], [ "data-observe-mutations", "observeMutations" ], [ "data-mutate-approach", "mutateApproach" ], [ "data-keep-original-source", "keepOriginalSource" ], [ "data-measure-performance", "measurePerformance" ], [ "data-show-missing-icons", "showMissingIcons" ] ].forEach(
			function (t) {
	...
	g && ((q = (p.documentElement.doScroll ? /^loaded|^c/ : /^loaded|^i|^c/).test( p.readyState )) || p.addEventListener(
		"DOMContentLoaded",
		function t() {
		p.removeEventListener( "DOMContentLoaded", t ), q = 1, Y.map(
			function (t) {
				return t();
			}
		);
		...
		return new pt(
			function (e, t) {
				...
				for (var i, o = 0; o < s.length; o++) {
					(i = s[o] ) && "function" == typeof i.then ? i.then( n( o ), t ) : a[o] = i;
				}
				r || e( a );
			}
		);
		...
		return new pt(
			function (t, n) {
				for (var e, a = 0; a < r.length; a++) {
					(e = r[a] ) && "function" == typeof e.then ? e.then( t, n ) : t( e );
				}
			}
		);
	}, pt.resolve = function (n) {
		return n && "object" === r( n ) && n.constructor === pt ? n : new pt(
			function (t) {
				t( n );
			}
		);
	...
	function At(t) {
		return t.classList ? kt( t.classList ) : (t.getAttribute( "class" ) || "").split( " " ).filter(
			function (t) {
				return t;
			}
		);
	...
	function Et(t) {
		var n                                = t.icons, e = n.main, a = n.mask, r = t.prefix, i = t.iconName, o = t.transform, s = t.symbol, c = t.title, l = t.extra, f = t.watchable, u = void 0 !== f && f, m = a.found ? a : e, d = m.width, h = m.height, p = "fa-w-".concat( Math.ceil( d / h * 16 ) ), g = [ V.replacementClass, i ? "".concat( V.familyPrefix, "-" ).concat( i ) : "", p ].filter(
			function (t) {
		...
		var b, y, w, x, k, A, C, M, N, S, z, O, E, j, P, L, T, _, I, R, H, D, F, X = W(
			{},
			v,
			{
				prefix: r,
	...
	function jt(t) {
		var n = t.content, e = t.width, a = t.height, r = t.transform, i = t.title, o = t.extra, s = t.watchable, c = void 0 !== s && s, l = W(
			{},
			o.attributes,
			i ? {
				title: i
	...
	var Pt = function () {}, Lt = V.measurePerformance && f && f.mark && f.measure ? f : {
		...
		for (o = void 0 === e ? (r = 1, t[l[0]]) : (r = 0, e); r < f; r++) {
			o = u( o, t[i = l[r]], i, t );
		}
		return o;
	};
	...
	function Vt(t) {
		return t.reduce(
			function (t, n) {
				...
				if (Wt[n]) {
					t.prefix = n; } else if (V.autoFetchSvg && -1 < [ "fas", "far", "fal", "fab", "fa" ].indexOf( n )) {
					t.prefix = n; } else if (e) {
						...
						n !== V.replacementClass && 0 !== n.indexOf( "fa-w-" ) && t.rest.push( n );
					}
					return t;
			},
			Ut()
	...
	function Gt(t) {
		...
		return "string" == typeof t ? Mt( t ) : "<".concat( n, " " ).concat(
			(e   = r, Object.keys( e || {} ).reduce(
				function (t, n) {
	...
	var Zt = {
		replace: function (t) {
			...
			if (n.parentNode && n.outerHTML) {
				n.outerHTML = e + (V.keepOriginalSource && "svg" !== n.tagName.toLowerCase() ? "\x3c!-- ".concat( n.outerHTML, " --\x3e" ) : ""); } else if (n.parentNode) {
		...
		nest: function (t) {
			var n = t[0], e = t[1];
			if (~At( n ).indexOf( V.replacementClass )) {
				return Zt.replace( t );
			}
	...
	function tn(e, t) {
		...
		if (0 === e.length) {
			a(); } else {
			var n = $t;
			V.mutateApproach === S && (n = h.requestAnimationFrame || $t), n(
				function () {
				...
				function (t) {
					nn || kt( t ).forEach(
						function (t) {
							...
							"attributes" === t.type && Qt( t.target ) && ~R.indexOf( t.attributeName )) {
	...
	var cn = function (t) {
		...
		return t ? t.toLowerCase().split( " " ).reduce(
			function (t, n) {
	...
	function ln(t) {
		...
		e                          = [], n && (e = n.split( ";" ).reduce(
			function (t, n) {
				var e = n.split( ":" ), a = e[0], r = e.slice( 1 );
				return a && 0 < r.length && (t[a] = r.join( ":" ).trim()), t;
			},
			{}
		)), e), d = cn( t.getAttribute( "data-fa-transform" ) ), h = null !== (a = t.getAttribute( "data-fa-symbol" )) && ("" === a || a), p = (i = kt( (r = t).attributes ).reduce(
			function (t, n) {
		...
		i.focusable = "false")), i), g = (s = t.getAttribute( "data-fa-mask" )) ? Vt(
			s.split( " " ).map(
				function (t) {
					return t.trim();
				}
	...
	function yn(t) {
		...
		return ~a.extra.classes.indexOf( P ) ? function (t, n) {
			...
			return V.autoA11y && ! e && (r.attributes["aria-hidden"] = "true"), gt.resolve(
				[ t, jt(
					{
						content: t.innerHTML,
						width: i,
		...
		f                                = n.symbol, e = n.mask, u = n.extra, new gt(
			function (r, t) {
				gt.all( [ vn( o, c ), vn( e.iconName, e.prefix ) ] ).then(
					function (t) {
	...
	function wn(t) {
		...
		if (g) {
			...
			}, i  = V.autoFetchSvg ? Object.keys( E ) : Object.keys( bn ), o = [ ".".concat( P, ":not([" ).concat( U, "])" ) ].concat(
				i.map(
					function (t) {
			...
			if (0 !== o.length) {
				...
				if (0 < s.length) {
					...
					var c = It.begin( "onTree" ), l = s.reduce(
						function (t, n) {
							try {
								var e = yn( n );
								e && t.push( e );
	...
	function kn(u, m) {
		...
		return new gt(
			function (a, t) {
				if (null !== u.getAttribute( d )) {
					return a();
				}
				var n   = kt( u.children ).filter(
					function (t) {
				...
				if (r) {
					...
					if (n && n.getAttribute( C ) === s && n.getAttribute( M ) === c) {
						a(); } else {
								...
								attributes: {}
												...
												f.attributes[w] = m, vn( c, s ).then(
													function (t) {
														...
														":before" === m ? u.insertBefore( e, u.firstChild ) : u.appendChild( e ), e.outerHTML = n.map(
															function (t) {
																return Gt( t );
															}
	...
	function jn(t) {
		...
		if (a) {
			return Kt( Ln.definitions, e, a ) || Kt( B.styles, e, a );
		}
	}
	var Pn, Ln = new(
		function () {
			...
			return n = t, (e = [ {
				key: "add",
				value: function () {
					for (var n = this, t = arguments.length, e = new Array( t ), a = 0; a < t; a++) {
						e[a] = arguments[a];
					}
					...
					Object.keys( r ).forEach(
						function (t) {
							n.definitions[t] = W( {}, n.definitions[t] || {}, r[t] ), function t(n, a) {
								var e = (2 < arguments.length && void 0 !== arguments[2] ? arguments[2] : {}).skipHooks, r = void 0 !== e && e, i = Object.keys( a ).reduce(
									function (t, n) {
										var e                         = a[n];
		...
		watch: function () {
			...
			! 1 === V.autoReplaceSvg && (V.autoReplaceSvg = ! 0), V.observeMutations = ! 0, K(
				function () {
					Hn(
						{
		...
		return En(
			...
			function () {
				return On(), function (t) {
					var n = t.content, e = t.title, a = t.extra, r = W(
						{},
						a.attributes,
						e ? {
							title: e
	...
	! function (t) {
		...
		u && (h.FontAwesome || (h.FontAwesome = Rn), K(
			function () {
				Hn(), rn(
					{
						treeCallback: wn,
